...
class Profile(TimestampedModel):
    # g a one-to-one relationship between the two, we
    ...
    # creates their account, so thats why blank=trie
    bio = models.TextField(blank=True)

    # In addition to the `bio` field, each user may have a profile image or
    # avatar. Similar to `bio`, this field is not required.
    image = models.URLField(blank=True)

    # This is an example of a Many-To-Many relationship where both sides of the
    # relationship are of the same model. Just because
    # you are following me does not mean that I am following you. This is
